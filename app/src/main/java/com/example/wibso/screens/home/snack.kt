...
val listSnacks = listOf(
    SnackItem("Cupcake", "", R.drawable.emoji),
    SnackItem("Donut", "", R.drawable.delete),
    SnackItem("Eclair", "", R.drawable.album),
    SnackItem("Froyo", "", R.drawable.album),
    SnackItem("Gingerbread", "", R.drawable.send),
    SnackItem("Honeycomb", "", R.drawable.emoji),
)
