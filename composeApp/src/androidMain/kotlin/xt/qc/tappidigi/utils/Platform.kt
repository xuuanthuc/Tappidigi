...
actual class Platform(private var context: Context, private var activity: Activity) {
    actual val name: String = "Android ${Build.VERSION.SDK_INT}"

    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    actual fun fetchImagesFromGallery(): List<GalleryImage> {
    ...
    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    actual fun checkImagePermission(): Boolean {
    ...
    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    actual fun checkVideoPermission(): Boolean {
    ...
    actual fun fetchVideosFromGallery(): List<GalleryVideo> {
